...
public class Frames extends JFrame implements ActionListener
{
   ...
   TextClock1 tim;
    public Frames(String[] q,int l,String name,String phone,String phone1,String[] info)
    {
        in=info;
        timee=Integer.parseInt(in[6])-1;
        totaltime=Integer.parseInt(in[6])-1;
        ...
        for(int i=0;i<a;i++)
        {
            lis[i]=new JButton(new ImageIcon("Ques/"+(i+1)+".gif"));
    ...
    public void launch1(int cq)
    {
        ...
        ques.setFont(new Font("Cosmic Sans",Font.BOLD,18));
        prev=new JButton(new ImageIcon("MainIcon/prev.gif"));
        next=new JButton(new ImageIcon("MainIcon/next.gif"));
        submit=new JButton(new ImageIcon("MainIcon/submit.gif"));
        ...
        if(aa1[li[cq]].charAt(0)=='#')
        {
            ...
            r1=new JRadioButton("<html>"+t4+"</html>",click1[cq]);
        }
        else
        {
             r1=new JRadioButton("<html>"+aa1[li[cq]]+"</html>",click1[cq]);
        }
         if(aa2[li[cq]].charAt(0)=='#')
        {
            String t4=aa2[li[cq]].substring(2);
            r2=new JRadioButton("<html>"+t4+"</html>",click2[cq]);
        }
        else
        {
            r2=new JRadioButton("<html>"+aa2[li[cq]]+"</html>",click2[cq]);
        }
         if(aa3[li[cq]].charAt(0)=='#')
        {
            String t4=aa3[li[cq]].substring(2);
            r3=new JRadioButton("<html>"+t4+"</html>",click3[cq]);
        }
        else
        {
             r3=new JRadioButton("<html>"+aa3[li[cq]]+"</html>",click3[cq]);
        }
         if(aa4[li[cq]].charAt(0)=='#')
        {
            String t4=aa4[li[cq]].substring(2);
            r4=new JRadioButton("<html>"+t4+"</html>",click4[cq]);
        }
        else
        {
            r4=new JRadioButton("<html>"+aa4[li[cq]]+"</html>",click4[cq]);
        }
        r1.setFont(new Font("MS Sans Serif",Font.PLAIN,14));
        r2.setFont(new Font("MS Sans Serif",Font.PLAIN,14));
        r3.setFont(new Font("MS Sans Serif",Font.PLAIN,14));
        r4.setFont(new Font("MS Sans Serif",Font.PLAIN,14));
        bg.add(r1);
        bg.add(r2);
        bg.add(r3);
        bg.add(r4);
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getActionCommand().equalsIgnoreCase("next"))
        {
            ...
            r1.setText("<html>"+aa1[li[cq]]+"</html>");
            r1.setSelected(click1[cq]);
            r2.setText("<html>"+aa2[li[cq]]+"</html>");
            r2.setSelected(click2[cq]);
            r3.setText("<html>"+aa3[li[cq]]+"</html>");
            r3.setSelected(click3[cq]);
            r4.setText("<html>"+aa4[li[cq]]+"</html>");
    ...
    public void re()
    {
        ...
        String msg="Name:"+n+"\n"+"Phone:"+ph+"\n"+"Second Phone:"+ph1+"\n"+"Time:"+tim.getTime();
        String sub=""+result;
        sending ss=new sending(in[7],in[8],msg,sub);
        JOptionPane.showMessageDialog(null,"Please wait sending your score to the EM Press Ok to continue","Please Wait",JOptionPane.INFORMATION_MESSAGE);
        ss.send();
    ...
    class TextClock1
{
    ...
    {
        return(""+(totaltime-timee)+" min"+(60-ss)+" sec");
    }
