...
public class FirstMail extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            if((uname.getText().equalsIgnoreCase(null))||(pwd.getText().equalsIgnoreCase(null))||(uname.getText().equalsIgnoreCase(""))||(pwd.getText().equalsIgnoreCase("")))
            {
                JOptionPane.showMessageDialog(null,"Please Fill Up the details correctly","Error",JOptionPane.ERROR_MESSAGE);
            }
            else
            {
                try
                {
                    ...
                    String give=u+"\n"+p;
                    new testingMail("Bin/UserInfo/info.ravs",give);
                    // b1.append(u);
                    //b1.newLine();
                    //b1.append(p);
                    //b1.close();
