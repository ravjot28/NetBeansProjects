...
public class ProductData {
	...
	public String toString() {
		return "ProductData [FirstOperationDate=" + FirstOperationDate
				+ ", LastChangedDate=" + LastChangedDate
				+ ", ManufacturedDate=" + ManufacturedDate + ", ProductName="
				+ ProductName + ", ProductNumber=" + ProductNumber
				+ ", ProductRevision=" + ProductRevision + ", SerialNumber="
				+ SerialNumber + ", Supplier=" + Supplier + "]";
	}
