                ...
                public void mouseClicked(MouseEvent me)
                {
                    ...
                    if(pp.y<row2)
                    {
                         if(pp.x<new Point(books[4].getLocationOnScreen()).x)
                        {
                            ...
                            {
                                System.out.println(apps[4][0]);
                                 new Rav(apps[4][0]).execute();
                            dispose();
                            }
                        else
                        {
                             System.out.println(apps[5][0]);
                    ...
                    if(pp.y<row3)
                    {
                         if(pp.x<new Point(books[7].getLocationOnScreen()).x)
                        {
                            ...
                            {
                                System.out.println(apps[7][0]);
                                 new Rav(apps[7][0]).execute();
                            dispose();
                            }
                        else
                        {
                             System.out.println(apps[8][0]);
                    ...
                    else
                    {
                         if(pp.x<new Point(books[10].getLocationOnScreen()).x)
                        {
                            ...
                            {
                                System.out.println(apps[10][0]);
                                 new Rav(apps[10][0]).execute();
                            dispose();
                            }
                        else
                        {
                             System.out.println(apps[11][0]);
