...
public class empdetailsit extends javax.swing.JFrame
{
    ...
    private javax.swing.JCheckBox jTextField1;
    private javax.swing.JCheckBox jTextField2;
    String empid;
    String mempid;

    public empdetailsit(String emp,String asd)
    {
        empid=asd;
        mempid=emp;
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jTextField1 = new javax.swing.JCheckBox();
        jTextField2 = new javax.swing.JCheckBox();
        jLabel1.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 51, 255));
        jLabel1.setText("IT Dept");

        jLabel2.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel2.setText("Employee Name (ID) : "+rav[1]+" ("+empid+")");

        jLabel3.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel3.setText("Desktop password disabled :");

        jLabel4.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel4.setText("Laptop Returned :");

        jLabel5.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel5.setText("Pen/USB drive returned , Visiting Card :");
        ...
        jButton2.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent evt)
            {
                ...
                String le="";
                String ic="";
                notice=jTextField2.isSelected();
                leave=jTextField1.isSelected();
                icard=jCheckBox1.isSelected();
                if(!notice)
                {
                    no="Desktop Password Not Changed";
                }
                if(!leave)
                {
                    le="Laptop Not Returned";
                }
                if(!icard)
                {
                    ic="Pen/USB drive not returned";
                }
                String message="";
     ...
     public void update(int a)
    {
        ...
        if(a==0)
        {
             ...
             try
             {
                ...
                sta.executeUpdate("UPDATE exitmanag SET confirmation='"+conf.charAt(0)+conf.charAt(1)+conf.charAt(2)+conf.charAt(3)+("0"+p)+"'"+" where emp_id="+empid);
                sta.close();
                con.close();
            } catch (Exception e) {    }
        }
        else
        {
            Connection con = null;
             try
             {
                ...
                sta.executeUpdate("UPDATE exitmanag SET confirmation='"+conf.charAt(0)+conf.charAt(1)+conf.charAt(2)+conf.charAt(3)+("2"+p)+"'"+" where emp_id="+empid);
                sta.close();
                con.close();
            } catch (Exception e) {    }
        }
