...
public class DetailStatusQueryProjectHead
{
    String project;
    DetailStatusQueryProjectHead(String a)
    {
        project=a;
    }
  ...
  public String[][] search(String rav)
  {
      ...
      Connection con = null;
        try
        {
            ...
            while(res.next())
            {
                ...
                if((""+conf.charAt(1)).equalsIgnoreCase("1"))
                {
                String data=res.getString("reason").trim();
                String pr=res.getString("currentproject").trim();
                if((!data.equalsIgnoreCase("na"))&&(project.trim().equalsIgnoreCase(pr)))
                {
      ...
      while(t.hasMoreTokens())
      {
          ...
          rec[ap][4]=data(""+ar.charAt(4));
          rec[ap][3]=data(""+ar.charAt(3));
          rec[ap][2]=data(""+ar.charAt(2));
          //rec[ap][1]=data(""+ar.charAt(1));
