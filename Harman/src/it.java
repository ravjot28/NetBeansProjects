...
public class it extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
       ...
       // jTable1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true));
        ...
        String a[][]=new DetailQueryit().search("D:/Harman.mdb");
        ...
        String a1[][]=new DetailStatusQueryit().search("D:/Harman.mdb");
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            a1,
            new String [] {
                "Employee", "Manager 1","Project Head", "HR","FLM","Admin", "Training"
            }
        ) {
            Class[] types = new Class [] {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if(t.convertRowIndexToModel(row)>=0 && t.convertColumnIndexToModel(col)>1 && t.convertColumnIndexToModel(col)<3)
        {
            if(t.convertColumnIndexToModel(col)==2)
            {
                ...
                if(conf.charAt(4)=='1')
                {
                    new empdetailsit(empid,o.toString().substring(o.toString().indexOf("(")+1,o.toString().lastIndexOf(")"))).setVisible(true);
                }
                else
                    if(conf.charAt(4)=='2')
                {
