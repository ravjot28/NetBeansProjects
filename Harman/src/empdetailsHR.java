...
public class empdetailsHR extends javax.swing.JFrame
{
    ...
    public empdetailsHR(String emp,String asd)
    {
        empid=asd;
        mempid=emp;
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jButton2.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent evt)
            {
                ...
                if(notice)
                {
                    no="Notice Pay recovery to be paid Rs."+jTextField2.getText().trim();
                }
                if(leave)
                {
                    le="Leave Balance to be paid Rs."+jTextField1.getText().trim();
                }
                if(!icard)
                {
                    ic="I-Card not recieved";
                }
                String message="";
     ...
     public void update(int a)
    {
        ...
        if(a==0)
        {
             ...
             try
             {
                ...
                sta.executeUpdate("UPDATE exitmanag SET confirmation='"+conf.charAt(0)+conf.charAt(1)+("0"+p)+"'"+" where emp_id="+empid);
                sta.close();
                con.close();
            } catch (Exception e) {    }
        }
        else
        {
            Connection con = null;
             try
             {
                ...
                sta.executeUpdate("UPDATE exitmanag SET confirmation='"+conf.charAt(0)+conf.charAt(1)+("2"+p)+"'"+" where emp_id="+empid);
                sta.close();
                con.close();
            } catch (Exception e) {    }
        }
