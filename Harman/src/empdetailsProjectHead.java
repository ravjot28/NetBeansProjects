...
public class empdetailsProjectHead extends javax.swing.JFrame
{
    ...
    public empdetailsProjectHead(String emp,String asd)
    {
        empid=asd;
        mempid=emp;
        initComponents();
    ...
    public void update(int a)
    {
        ...
        if(a==0)
        {
             ...
             try
             {
                ...
                con = DriverManager.getConnection(driver,"","");
                Statement sta = con.createStatement();
                sta.executeUpdate("UPDATE exitmanag SET confirmation='"+conf.charAt(0)+("0"+p)+"'"+" where emp_id="+empid);
                sta.close();
                con.close();
            } catch (Exception e) {    }
        }
        else
        {
            Connection con = null;
             try
             {
                ...
                sta.executeUpdate("UPDATE exitmanag SET confirmation='"+conf.charAt(0)+("2"+p)+"'"+" where emp_id="+empid);
                sta.close();
                con.close();
            } catch (Exception e) {    }
        }
