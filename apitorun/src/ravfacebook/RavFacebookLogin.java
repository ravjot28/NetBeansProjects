...
public class RavFacebookLogin
{
    public static String RavLogin(String API_KEY, String SECRET_KEY, final String email, final String password) throws FacebookException, HttpException, IOException
    {
        ...
        return session; //First needs to give all the permissions to the app and only then return the session
    }
}