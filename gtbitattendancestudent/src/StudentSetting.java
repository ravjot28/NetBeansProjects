...
public class StudentSetting extends JFrame
{
    ...
    public StudentSetting(String e,String em,String p)
    {
        enroll=e;
        email=em;
        password = p;
                                                ...
                                                if(jPasswordField1.getText().trim().equalsIgnoreCase(password))
                                                {
                                                    if(jPasswordField2.getText().trim().equalsIgnoreCase(jPasswordField3.getText().trim()))
                                                    {
                                                        try
                                                        {
                                                            ...
                                                            b.append(new Base64Encoder(new Base64Encoder(enroll).get()).get());
                                                            b.newLine();
                                                            b.append(new Base64Encoder(new Base64Encoder(email).get()).get());
                                                            b.newLine();
