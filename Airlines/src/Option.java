...
public class Option extends JFrame implements ActionListener,Runnable
{
    ...
    public void mk(String strManyDirectories)
   {
     ...
     public void run() {
         ...
         String aa[]={new Dir().getdir()+"test/Temp2/Temp3/Temp4/Temp5/Temp6/Temp7/Temp8/Temp9/Temp10/Temp11/Temp12/Complete Pay Slip.pdf"};
    ...
    JTextComponent.loadKeymap(k, newBindings, pas.getActions());
     ...
     public void view()
     {
          try {
            ...
            String cmd1="rundll32" + " " + "url.dll,FileProtocolHandler" + " "+new Dir().getdir()+"test/Temp2/Temp3/Temp4/Temp5/Temp6/Temp7/Temp8/Temp9/Temp10/Temp11/Temp12/Salary_Slips.pdf";
            String cmd="rundll32" + " " + "url.dll,FileProtocolHandler" + " "+new Dir().getdir()+"test/Temp2/Temp3/Temp4/Temp5/Temp6/Temp7/Temp8/Temp9/Temp10/Temp11/Temp12/PLI1.pdf";
            try {
     ...
     public void merge()
     {
        try{
            ...
            String cmd1="rundll32" + " " + "url.dll,FileProtocolHandler" + " "+new Dir().getdir()+"test/Temp2/Temp3/Temp4/Temp5/Temp6/Temp7/Temp8/Temp9/Temp10/Temp11/Temp12/Merged.pdf";
            try {
                Process pro = Runtime.getRuntime().exec(cmd1);}catch(Exception cdz){}
     }
