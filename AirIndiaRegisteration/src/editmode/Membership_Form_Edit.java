...
public class Membership_Form_Edit extends javax.swing.JFrame implements Runnable
{
    URL imageURL = getClass().getClassLoader().getResource("img/rav.gif");
    URL imageURL1 = getClass().getClassLoader().getResource("img/logo.png");
    URL imageURL2 = getClass().getClassLoader().getResource("img/calendar.png");
    ...
    public Membership_Form_Edit(String[] i,ArrayList<String> n)
    {
        this.information = i;
        this.nominations = n;
        d = tk.getScreenSize();
    ...
    {
        this.FullName.setText(information[0]);
        this.FullName.setEnabled(false);

        this.Staffno.setText(information[1]);
        this.Staffno.setEnabled(false);

        this.Address.setText(information[2]);
        this.Address.setEnabled(true);

        this.City.setText(information[3]);
        this.City.setEnabled(true);

        this.State.setText(information[4]);
        this.State.setEnabled(true);

        this.PinCode.setText(information[5]);
        this.PinCode.setEnabled(true);

        StringTokenizer s1 = new StringTokenizer(information[6],"-");

        this.TeleCode.setText(s1.nextToken().trim());
        this.TeleCode.setEnabled(true);

        this.LandlineNo.setText(s1.nextToken().trim());
        this.LandlineNo.setEnabled(true);

        this.MobileNo.setText(information[7].trim());
        this.MobileNo.setEnabled(true);

        this.EmailId.setText(information[8]);
        this.EmailId.setEnabled(true);

        this.PinCode1.setText(information[9]);
        this.PinCode1.setEnabled(false);
    ...
    public void run()
    {
        ...
        if(d == null)
        {
            ...
            java.awt.EventQueue.invokeLater(new Runnable()
            {
                public void run()
                {
                    new Agreement_Form_Edit(information,nominations).setVisible(true);
                }
            });
        }
        else
        {
           ...
           {
               JOptionPane.showMessageDialog(null,"Oops!! Staff No."+Staffno.getText().trim()+" is not registered", null, WIDTH);
               ipp.stop();
           }
        }
    }
