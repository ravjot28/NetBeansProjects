...
public class Nomination_Form_Edit extends javax.swing.JFrame implements ItemListener,Runnable
{
    ...
    public Nomination_Form_Edit(String[] i,ArrayList<String> n)
    {
        this.nominations1 = n;
        this.information = i;
        d = tk.getScreenSize();
    ...
    private void initComponents()
    {
        ...
        setTitle("BSAEIA Nomination Form [Edit Mode]");
    ...
    {
        int count = nominations1.size();
        String data[] = new String[count];
        int i=0;
        for(String temp:nominations1)
        {
            data[i] = temp;
            i++;
        }
        ...
        if(count==1)
        {
            StringTokenizer s1 = new StringTokenizer(data[0],"||");

            jTextField1.setText(s1.nextToken().trim());
            jComboBox2.setSelectedItem(s1.nextToken());
            jTextField2.setText(s1.nextToken().trim());
            jTextField3.setText(s1.nextToken().trim());
            jComboBox3.setSelectedItem(s1.nextToken().trim());
            jTextField4.setText(s1.nextToken().trim());
            jTextField5.setText(s1.nextToken().trim());
            jTextField6.setText(s1.nextToken().trim());
            jTextArea1.setText(s1.nextToken().trim());
        ...
        if(count==2)
        {
            ...
            s1 = new StringTokenizer(data[1],"||");

            jTextField7.setText(s1.nextToken().trim());
            jComboBox4.setSelectedItem(s1.nextToken());
            jTextField8.setText(s1.nextToken().trim());
            jTextField9.setText(s1.nextToken().trim());
            jComboBox5.setSelectedItem(s1.nextToken().trim());
            jTextField10.setText(s1.nextToken().trim());
            jTextField11.setText(s1.nextToken().trim());
            jTextField12.setText(s1.nextToken().trim());
            jTextArea2.setText(s1.nextToken().trim());
        ...
        if(count==3)
        {
            ...
            s1 = new StringTokenizer(data[2],"||");

            jTextField13.setText(s1.nextToken().trim());
            jComboBox6.setSelectedItem(s1.nextToken());
            jTextField14.setText(s1.nextToken().trim());
            jTextField15.setText(s1.nextToken().trim());
            jComboBox7.setSelectedItem(s1.nextToken().trim());
            jTextField16.setText(s1.nextToken().trim());
            jTextField17.setText(s1.nextToken().trim());
            jTextField18.setText(s1.nextToken().trim());
            jTextArea3.setText(s1.nextToken().trim());
        ...
        if(count==4)
        {
            ...
            s1 = new StringTokenizer(data[3],"||");

            jTextField19.setText(s1.nextToken().trim());
            jComboBox8.setSelectedItem(s1.nextToken());
            jTextField20.setText(s1.nextToken().trim());
            jTextField21.setText(s1.nextToken().trim());
            jComboBox9.setSelectedItem(s1.nextToken().trim());
            jTextField22.setText(s1.nextToken().trim());
            jTextField23.setText(s1.nextToken().trim());
            jTextField24.setText(s1.nextToken().trim());
            jTextArea4.setText(s1.nextToken().trim());
    ...
    public void run()
    {
        ...
        if(new CheckInternetConnection().process())
        {
            ...
            ipp.repaint();
            ipp.revalidate();
            SendEmployeeRequest ser = new SendEmployeeRequest("E"+subject,message);
            if(ser.process())
            {
                ipp.setText("Modifying Details.....");
                ipp.repaint();
                ipp.revalidate();
                ...
                try
                {
                    ...
                    BufferedWriter b = new BufferedWriter(new FileWriter(dir+System.getProperty("file.separator")+subject+".ravs"));
                    b.append(message);
                    b.close();
                }catch(Exception sd){}
