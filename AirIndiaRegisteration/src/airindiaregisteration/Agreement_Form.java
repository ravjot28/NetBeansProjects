...
public class Agreement_Form extends javax.swing.JFrame
{
    ...
    public Agreement_Form(String[] i)
    {
        d = tk.getScreenSize();
        this.information = i;
        initComponents();
    ...
    private void initComponents()
    {
        ...
        setTitle("BSAEIA Agreement Form");
        ...
        jButton1.addActionListener(new ActionListener()
                                    {
                                        public void actionPerformed(ActionEvent ae)
                                        {
                                            ...
                                            java.awt.EventQueue.invokeLater(new Runnable()
                                            {
                                                public void run()
                                                {
                                                    new Nomination_Form(information).setVisible(true);
                                                }
                                            });
