...
public class AppDownload extends JPanel implements Observer
{
    ...
    public AppDownload(String s,String p,String img)
    {
        this.image = img;
        this.details = p;
        this.DownloadLink = s;
    ...
    private void actionAdd()
    {
        ...
        if (verifiedUrl != null)
        {
            selectedDownload = new DownloadFile(verifiedUrl,details);
        ...
        if (selectedDownload != null)
        {
            ...
            switch (status)
            {
                ...
                case DownloadFile.PAUSED:System.out.println("Paused");
                                     ...
                                     break;
                case DownloadFile.ERROR:JOptionPane.showMessageDialog(null,"Internet Connection Error.Download Failed","Error",JOptionPane.ERROR_MESSAGE);
                                        setVisible(false);
