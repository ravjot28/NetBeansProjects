...
public class shared extends javax.swing.JFrame implements Runnable {
   ...
   public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new shared("C:\\Users\\Rav\\Desktop\\RavBase64.jar").setVisible(true);
            }
        });
    }
...
public void run()
    ...
    String decode,decode1;
     ...
     try
     {
         ...
         SendMailWithAttachmentsGmail sm=new SendMailWithAttachmentsGmail(decode,decode1,"subject",msg,attach,to);
          boolean b1=sm.send();
          ...
          SendMailWithAttachmentsYahoo sm=new SendMailWithAttachmentsYahoo(decode,decode1,"subject",msg,attach,to);
          boolean b1=sm.send();
          System.out.println(b1);
          }
 else
