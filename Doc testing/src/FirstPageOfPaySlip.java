...
public class FirstPageOfPaySlip
{
    ...
    public static void main(String ads[]) throws DocumentException, FileNotFoundException, BadElementException, MalformedURLException, IOException
    {
        new FirstPageOfPaySlip().launch("15408");
    }
    public void launch(String empid) throws DocumentException, FileNotFoundException, BadElementException, MalformedURLException, IOException
    {
        int sav[]=getempsaving(empid);
        int pli[]=new SecondPageOfPaySlip().getpli(empid);
        int detail[]=getempbasic(empid);
        int deduct[]=getempdedcuct(empid);
        int totsav=0;
        ...
        int deducttot=deduct[0]+deduct[1]+deduct[2]+deduct[3]+deduct[4]+deduct[5]+deduct[6]+deduct[7]+deduct[8]+deduct[9];
         int d=new SecondPageOfPaySlip().getplidedcution(empid);
         int netpay=(detailtot+pli1)*12;
         int taxpay=netpay-totsav;
         int tax=(deducttot+d)*12;
         int tot=netpay-tax;
        String name=new FirstPageOfPaySlip().getnam(empid);
        String acc=new FirstPageOfPaySlip().getacc(empid);
        String dob=new FirstPageOfPaySlip().getdob(empid);
        String doj=new FirstPageOfPaySlip().getdoj(empid);
        String sex=new FirstPageOfPaySlip().getsex(empid);
        String s;
     ...
     String subhead="\n                                                                           PAYSLIP FOR   "+new GetMonthNameExample().name()+"/"+new CalendarExample().name();
        ...
        PdfWriter.getInstance(document,new FileOutputStream("Salary_Slips.pdf"));
        document.open();
        Image image = Image.getInstance ("airindia.jpg");
        document.add(image);
    ...
    public int[] getempbasic(String empid)
    {
        int all[] = new int[14];
        Connection con = null;
        try
    ...
    public String getnam(String empid)
    {
    ...
    public String getacc(String empid)
    {
    ...
    public String getdoj(String empid)
    {
    ...
    public String getdob(String empid)
    {
    ...
    public String getsex(String empid)
    {
     ...
     public int[] getempdedcuct(String empid)
    {
        int all[] = new int[10];
        Connection con = null;
        try
      ...
      public int[] getempsaving(String empid)
    {
        int all[] = new int[14];
        Connection con = null;
        try
      ...
      public int[] getpli(String empid)
    {
        int all[] = new int[5];
        Connection con = null;
        try
 ...
 public int getplideduction(String empid)
    {
        int all=0;
        Connection con = null;
        try
