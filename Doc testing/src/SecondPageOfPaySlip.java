...
public class SecondPageOfPaySlip
{
    ...
    public int d;
    public int tot;
    public static void main(String ads[]) throws DocumentException, FileNotFoundException, BadElementException,IOException
    {
        new SecondPageOfPaySlip().launch("15400");
    }
    public void launch(String empid) throws DocumentException, FileNotFoundException, BadElementException,IOException
    {
        int pli[]=new SecondPageOfPaySlip().getpli(empid);
        d=new SecondPageOfPaySlip().getplidedcution(empid);
     ...
     String subhead="\n                                                                           PAYSLIP FOR   "+new GetMonthNameExample().name()+"/"+new CalendarExample().name();
        ...
        PdfWriter.getInstance(document,new FileOutputStream("Salary_Slips1.pdf"));
        document.open();
    ...
    public int[] getpli(String empid)
    {
     ...
     public int getplidedcution(String empid)
    {
        int all = 0 ;
        Connection con = null;
        try
