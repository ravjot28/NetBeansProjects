...
public class FirstPdf
{
	private static String FILE = "FirstPdf.pdf";
        private static Font catFont=FontFactory.getFont(FontFactory.COURIER, 14, Font.BOLD, new Color(255, 150, 200));
	...
	private static void addMetaData(Document document)
        {
		document.addTitle("My First PDF creator");
		document.addSubject("Using java");
	...
	private static void addTitlePage(Document document) throws DocumentException
		...
		preface.add(new Paragraph("This document is a preliminary version and not subject to your license agreement or any other agreement with vogella.de ;-).",
						redFont));
