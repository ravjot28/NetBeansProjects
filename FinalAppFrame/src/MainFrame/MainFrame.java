                ...
                public void mouseClicked(MouseEvent me)
                {
                    ...
                    if(pp.y<row1)
                    {
                        if(pp.x<new Point(books[1].getLocationOnScreen()).x)
                        {
                            ...
                            if(pp.x<new Point(books[2].getLocationOnScreen()).x)
                            {
                                ...
                                if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\TwitterWin\\RTweetWin.jar").execute();
                                    }
                                    else
                                    {
                        ...
                        else
                        {
                            ...
                            if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\YoutubeWin\\Youtube.jar").execute();
                                    }
                                    else
                                    {
                    ...
                    if(pp.y<row2)
                    {
                         if(pp.x<new Point(books[4].getLocationOnScreen()).x)
                        {
                             ...
                             if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\GTBIT\\Student\\GTBITStudent.jar").execute();
                                    }
                                    else
                                    {
                                        new Rav("Bin/Data/Apps/GTBIT/Student/GTBITStudent.jar").execute();
                        ...
                        else
                        {
                             ...
                             if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\MP3Win\\Mp3Win.jar").execute();
                                    }
                                    else
                                    {
                    ...
                    if(pp.y<row3)
                    {
                         if(pp.x<new Point(books[7].getLocationOnScreen()).x)
                        {
                             ...
                             if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\MailNotifier\\MailNotifier.jar").execute();
                                    }
                                    else
                                    {
                                        new Rav("Bin/Data/Apps/MailNotifier/MailNotifier.jar").execute();
                            ...
                            if(pp.x<new Point(books[8].getLocationOnScreen()).x)
                            {
                                ...
                                if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\RMailSenderWin\\RMailSenderWin.jar").execute();
                                    }
                                    else
                                    {
                        ...
                        else
                        {
                             ...
                             if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\iTunesControllerWin\\MaciTunesController.jar").execute();
                                    }
                                    else
                                    {
                    ...
                    else
                    {
                         ...
                         if(pp.x<new Point(books[10].getLocationOnScreen()).x)
                        {
                             if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\Speak\\Speaking.jar").execute();
                                    }
                                    else
                                    {
                                        new Rav("Bin/Data/Apps/Speak/Speaking.jar").execute();
                            ...
                            if(pp.x<new Point(books[11].getLocationOnScreen()).x)
                            {
                                ...
                                if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("Bin\\Data\\Apps\\txt2pdf\\txtpdfconverter.jar").execute();
                                    }
                                    else
                                    {
                                        new Rav("Bin/Data/Apps/txt2pdf/txtpdfconverter.jar").execute();
                                    }
                                    dispose();
                        ...
                        else
                        {
                             ...
                             if(new GetOSName().getName().equals("win"))
                                    {
                                        new Rav("SoftwareUpdation.jar").execute();
                                    }
                                    else
                                    {
                                        new Rav("SoftwareUpdation.jar").execute();
    ...
    class MainPanel extends JPanel
{
    ...
    private void initComponents()
    {
       ...
       head.setIcon(new ImageIcon("Bin\\img\\search2.png"));
