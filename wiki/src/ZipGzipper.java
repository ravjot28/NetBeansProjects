...
public class ZipGzipper {
  ...
  public static void main(String s[])
    {
      zipFile(new File("c.txt"),new File("D:\\"));
  }
  public static int zipFile (File file_input, File dir_output) {
    ...
    try {
      ...
      // which will compress the data before writing it to the archive output.
  ...
  /**
    ...
    *  ".gz" appended to it. The archive will be in the chosen output directory.
   **/
