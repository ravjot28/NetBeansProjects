...
public class Opening extends JFrame implements ActionListener
{
                                    ...
                                    add.addActionListener(new ActionListener()
                                    {
                                        ...
                                        public void actionPerformed(ActionEvent e)
                                        {
                                            ...
                                            if((t.getText()!="")&&(t.getText()!=null))
                                            {
                                                try
                                                {
                                                    BufferedWriter bf=new BufferedWriter(new FileWriter("Playlist.rav",true));
                                                    bf.append(t.getText());
                                                    bf.newLine();
                                                    bf.close();
                                                }catch(Exception eee){}
    ...
    public void tablee()
    {
        ...
        Object[][] data =new Object[getNumberOfLines("Playlist.rav")][2];
        int i=1;
        String data1=null;
        try
        {
            BufferedReader b=new BufferedReader(new FileReader("Playlist.rav"));
            data1=b.readLine();
            while(data1!=null)
            {
