 ...
 * @author Ravjot
 */
public class MembershipFormEditNomineesDetailsController implements Initializable, ControlledScreen {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        List<NomineeDetails> nominees = membershipInfo.getNomineeDetails();
        int count = 0;
        if (nominees != null) {
            for (NomineeDetails nd : nominees) {
                switch (count) {
                    case 0:
                        nominee1FullName.setText(nd.getFullName());
                        nominee1Age.setText(nd.getAge());
                        nominee1Relative.setText(nd.getRelative());
                        nominee1IdentificationProof.setText(nd.getIdentificationProofs());
                        nominee1Related.setText(nd.getRelated());
                        nominee1Percentage.setText(nd.getPercentage());
                        nominee1Address.setText(nd.getAddress());
                        nominee1RelativeInfo.getSelectionModel().select(nd.getRelativeInfo());
                        nominee1Proofs.getSelectionModel().select(nd.getProofs());
                        break;
                    case 1:
                        nominee1FullName.setText(nd.getFullName());
                        nominee1Age.setText(nd.getAge());
                        ...
                        break;
                    case 2:
                        nominee2FullName.setText(nd.getFullName());
                        nominee2Age.setText(nd.getAge());
                        nominee2Relative.setText(nd.getRelative());
                        nominee2IdentificationProof.setText(nd.getIdentificationProofs());
                        nominee2Related.setText(nd.getRelated());
                        nominee2Percentage.setText(nd.getPercentage());
                        nominee2Address.setText(nd.getAddress());
                        nominee2RelativeInfo.getSelectionModel().select(nd.getRelativeInfo());
                        nominee2Proofs.getSelectionModel().select(nd.getProofs());
                        break;
                    case 3:
                        nominee3FullName.setText(nd.getFullName());
                        nominee3Age.setText(nd.getAge());
                        nominee3Relative.setText(nd.getRelative());
                        nominee3IdentificationProof.setText(nd.getIdentificationProofs());
                        nominee3Related.setText(nd.getRelated());
                        nominee3Percentage.setText(nd.getPercentage());
                        nominee3Address.setText(nd.getAddress());
                        nominee3RelativeInfo.getSelectionModel().select(nd.getRelativeInfo());
                        nominee3Proofs.getSelectionModel().select(nd.getProofs());
                        break;
                    case 4:
                        nominee4FullName.setText(nd.getFullName());
                        nominee4Age.setText(nd.getAge());
                        nominee4Relative.setText(nd.getRelative());
                        nominee4IdentificationProof.setText(nd.getIdentificationProofs());
                        nominee4Related.setText(nd.getRelated());
                        nominee4Percentage.setText(nd.getPercentage());
                        nominee4Address.setText(nd.getAddress());
                        nominee4RelativeInfo.getSelectionModel().select(nd.getRelativeInfo());
                        nominee4Proofs.getSelectionModel().select(nd.getProofs());
                        break;
                }
                count++;
            }
