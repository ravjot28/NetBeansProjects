 ...
 * @author Ravjot
 */
public class MembershipFormEditAddressDetailsController implements Initializable, ControlledScreen{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        address.setText(membershipInfo.getAddressDetails().getAddress());
        city.setText(membershipInfo.getAddressDetails().getCity());
        state.setText(membershipInfo.getAddressDetails().getState());
        pinCode.setText(membershipInfo.getAddressDetails().getPinCode());
    }
    ...
    public void moveToEmployeeDetailsPage() {
        myController.setScreen(GlobalConstants.employeeDetailsEditScreen);
    }
    ...
    public void moveToContactDetailsPage() throws IOException {
        ...
        if (address == null || address.trim().length() == 0) {
            ...
            myController.setScreen(GlobalConstants.contactDetailsEditScreen);
        }
    }
