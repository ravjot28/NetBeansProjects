 ...
 * @author Ravjot
 */
public class MembershipFormContactDetailsController implements Initializable, ControlledScreen {
    ...
    public void addNomineeDetailsHandler() {
        ...
        root.getChildren().addAll(myController.getNodeScreen(GlobalConstants.nomineeDetailsScreen));
        root.autosize();
    ...
    public void submitButtonHandler() {
        ...
        if (emailId == null || emailId.trim().length() == 0) {
            ...
            myController.setScreen(GlobalConstants.agreementScreen);
        }
    }
}
